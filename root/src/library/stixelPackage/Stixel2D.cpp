...
void Stixel2D::refreshTopAndBottonPoints(cv::Point2d point1,
		cv::Point2d point2) {
	initStixel(point1, point2);
}
...
void Stixel2D::sortTopAndBottonPoints(cv::Point2d* topPoint,
...
void Stixel2D::initStixel(cv::Point2f point1, cv::Point2f point2) {
	...
	this->size = LineTools::calcLenghtFrom2Points(this->topPoint,
			this->bottonPoint);
	this->center = LineTools::calcCenterFrom2Points(this->topPoint,
			this->bottonPoint);
	this->lineEquation = LineTools::calcLineEquation2D(this->topPoint,
			this->bottonPoint);
